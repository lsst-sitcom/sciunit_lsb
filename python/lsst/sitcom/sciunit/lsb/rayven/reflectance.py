...
class Reflectance:
    def __init__(self, band, L1=None, L2=None, L3=None, fil=None, det=None, base_path=DATA_DIR):  # (E2V, ITL)
    ...
    def _process_detector(self, val, detector_name=["E2V", "ITL"]):
        ...
        if val is None:
            ...
            for name in detector_name:
                throughput_data = Table.read(
                    f"{os.path.join(self._base_path, name)}.dat",
                    format="ascii",
                    comment="#",
            ...
            raise ValueError("The code that addresses this needs fixing - `name` is unbound")
    ...
    def _process_optic(self, val, optic_name):
        ...
        if val is None:
            ...
            throughput_data = Table.read(
                f"{os.path.join(self._base_path, optic_name)}.dat",
                format="ascii",
                comment="#",
                names=("wav", "throughput"),
            )
